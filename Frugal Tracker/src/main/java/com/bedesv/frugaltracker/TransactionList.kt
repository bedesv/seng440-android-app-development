...
@Composable
fun TransactionList(navigationController: NavController, inputTransactions:  MutableState<List<Transaction>>? = null) {
    val transactionService = TransactionService.getInstance()

    val transactions = inputTransactions ?: remember{ mutableStateOf(transactionService.getAll())}
